...
enum asynchronous_admin_type {
    ...
    ASYNCHRONOUS_DELETE_USER_PASSWORD,
    ASYNCHRONOUS_UPDATE_USER_PASSWORD,
    ASYNCHRONOUS_CREATE_SINGLE_TABLE,
    ASYNCHRONOUS_CREATE_SHARD_TABLE,
    ASYNCHRONOUS_CREATE_VDB,
